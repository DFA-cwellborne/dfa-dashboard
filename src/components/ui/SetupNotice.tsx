  ...
  return (
    <Card className="border-gold/40 bg-gold/5">
      ...
      <p className="mt-2 max-w-xl text-sm text-navy/70">
        ...
        project URL/keys, run the migrations in{" "}
        <code className="rounded bg-navy/10 px-1 py-0.5">supabase/migrations/</code>, then set{" "}
        <code className="rounded bg-navy/10 px-1 py-0.5">USE_MOCK_DATA=true</code> and run{" "}
        <code className="rounded bg-navy/10 px-1 py-0.5">npm run seed:mock</code> to verify everything
        end-to-end with generated sample data before wiring up real credentials.
      </p>
    </Card>
  );
}
